...
- start app
- go to http://localhost:3000/api and try POST /seed to add 10_000_000 random document to DB
...
- add index to DB uncomment DataSchema.index({ name: 1 }) in src/documents/schemas/document.schema.ts
